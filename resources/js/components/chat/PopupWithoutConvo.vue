...
<div class="msg_box" style="right: 270px">
    <div class="msg_head" style="background: #ffbc05;">
        <a href="#">
    ...
    <div class="msg_wrap">
        ...
        <div class="msg_footer text-block">
            <input v-model="newMessage" @keydown="isTyping" type="text" placeholder="Type and hit enter" class="msg_input form-control">
            <span class="field-error">{{ String(errors.message) }}</span>
            <!--<i v-if="typingUser != null" v-show="typing"> {{ typingUser }} is typing...</i>-->
                
            <button class="send-msg-btn btn btn-success" :disabled="emptyMessage" @click.prevent="sendMessage" style="border: 0;">
                <i class="fa fa-paper-plane" style="top: 5px"></i>
            </button>
        </div>
    </div>
</div>
...
export default {
    ...
    methods: {
        getMessages(user_id) {
            ...
            let url = `/messages-without-convo/${user_id}`;
        ...
        sendMessage() {
            ...
            let url = `/send-message-without-convo/${user_id}`;
