...
<div class="msg_box" style="right: 270px">
        ...
        <div class="msg_wrap">
            ...
            <div class="msg_footer text-block">
                <input v-model="newMessage" @keydown="isTyping" :disabled="noChatSelected" type="text" placeholder="Type and hit enter" class="msg_input form-control">
                <span class="field-error">{{ String(errors.message) }}</span>
                <!--<i v-if="typingUser != null" v-show="typing"> {{ typingUser }} is typing...</i>-->
                
                <button class="send-msg-btn btn btn-success" :disabled="noChatSelected || emptyMessage" @click.prevent="sendMessage" style="border: 0;">
